...
from Satya import MONGO_DB_URI
from Satya import telethn
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"Satya/modules/{shortname}.py")
        name = "Satya.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules["Satya.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "Satya/modules/*.py"

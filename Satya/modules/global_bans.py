...
import Satya.modules.sql.global_bans_sql as sql
from Satya.modules.sql.users_sql import get_user_com_chats
from Satya import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from Satya.modules.helper_funcs.misc import send_to_list

from Satya import pbot as app
from Satya.pyrogramee.errors import capture_err
from Satya.pyrogramee.json_prettify import json_prettify
from Satya.pyrogramee.fetch import fetch

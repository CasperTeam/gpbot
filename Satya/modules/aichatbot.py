...
import requests
import re
from Satya import pbot as LYCIA
...
async def lycia(client, message):
    ...
    if chat_id in en_chats:
        ...
        result = result.replace("Hi~", "Hello Friend I Am @A_L_SATYA")
        result = result.replace("My dear great botmaster, Lyciabot Team.", "Made By @A_L_SATYA")
        result = result.replace("Have the control right.", "My Father Is @A_L_SATYA")
        result = result.replace("I was created by Lyciabot Team.", "I was created by @A_L_SATYA.")
...
async def redaura(client, message):
    ...
    result = result.replace('"}', "")
    result = result.replace("Aco", "tiana")
    result = result.replace("Eliza", "@A_L_SATYA")
    result = result.replace("Hi~", "Hello Friend I Am @A_L_SATYA")
    result = result.replace("My dear great botmaster, Lyciabot Team.", "Made By @A_L_SATYA")
    result = result.replace("Have the control right.", "My Father Is @A_L_SATYA")
    result = result.replace("I was created by Lyciabot Team.", "I was created by @A_L_SATYA.")
...
async def redaura(client, message):
    ...
    result = result.replace("Eliza", "@A_L_SATYA")
    result = result.replace("Hi~", "Hello Friend I Am @A_L_SATYA")
    result = result.replace("My dear great botmaster, Daisybot Team.", "Made By @A_L_SATYA")
    result = result.replace("Have the control right.", "My Father Is @A_L_SATYA")
    result = result.replace("I was created by Lyciabot Team.", "I was created by @A_L_SATYA.")
    result = result.replace("<a href=\\", "<a href =")
    result = result.replace("<\/a>", "</a>")

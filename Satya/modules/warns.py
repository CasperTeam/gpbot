...
import telegram
from Satya import TIGERS, WOLVES, dispatcher
from Satya.modules.disable import DisableAbleCommandHandler
from Satya.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from Satya.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from Satya.modules.helper_funcs.string_handling import split_quotes
from Satya.modules.log_channel import loggable
from Satya.modules.sql import warns_sql as sql
...
def set_warn_limit(update: Update, context: CallbackContext) -> str:
    ...
    if args:
        if args[0].isdigit():
            if int(args[0]) < 50:
                msg.reply_text("The minimum warn limit is 50 !")
            else:

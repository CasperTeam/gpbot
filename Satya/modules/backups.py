...
import Satya.modules.sql.notes_sql as sql
from Satya import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Satya.__main__ import DATA_IMPORT
from Satya.modules.helper_funcs.chat_status import user_admin
from Satya.modules.helper_funcs.alternate import typing_action

# from Satya.modules.rules import get_rules
import Satya.modules.sql.rules_sql as rulessql

# from Satya.modules.sql import warns_sql as warnssql
import Satya.modules.sql.blacklist_sql as blacklistsql
from Satya.modules.sql import disable_sql as disabledsql

# from Satya.modules.sql import cust_filters_sql as filtersql
# import Satya.modules.sql.welcome_sql as welcsql
import Satya.modules.sql.locks_sql as locksql
from Satya.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("Satya{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Satya{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Satya-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Satya{}.backup".format(chat_id))  # Cleaning file
